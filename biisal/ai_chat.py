                        ...
                        [
                            [
                                InlineKeyboardButton(
                                    "sᴛᴀʀᴛ ᴍᴇ 🚩",
                                    url=f"https://t.me/ftmgpt_bot?start=z",
                                )
                            ]
                        ]
                    ),
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "Join 🚩",
                            url=f"https://t.me/ftmbotzsupport",
                        )
                    ]
                ]
            ),
            ...
            await text.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "sᴛᴀʀᴛ ᴍᴇ 🚩", url=f"https://t.me/ftmgpt_bot?start=z"
                            )
                        ]
                    ]
                ),
